  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
          ...
          storedCart.map(async (item) => {
            try {
              const productResponse = await fetch(
                `https://mavy-pxtx.onrender.com/user/products?pid=${item.productId}`,
                {
                  method: "GET",
                  credentials: "include",
                }
        ...
        const validProducts = fetchedProductDetails.filter(
          (item) => item !== null
        );
    ...
    try {
      ...
      setProductsDetails((prevProducts) =>
        prevProducts.filter(
          (product) =>
            !(
              product.productDetails._id === itemId &&
  ...
  const handleCheckout = async () => {
    ...
    try {
      const response = await fetch(
        "https://mavy-pxtx.onrender.com/user/checkout",
        {
          method: "POST",
          headers: {
            ...
            {isLoading ? (
              ...
              productsDetails.map((item) => {
                ...
                return (
                  <div
                    className="cart-item"
                    key={item.productDetails._id || item._id}
                  >
                    ...
                    >
                      <i className="text-red-500 bg-transparent cross-icon">
                        <b>X</b>
                      </i>
                    </div>
                  </div>
              ...
              <div className="c-info">
                ...
                <div className="c-l-info">
                  <div>
                    ...
                    <h4>
                      ${parseFloat((totalBill + shippingCharge).toFixed(2))}
                    </h4>
                  </div>
                </div>
              </div>
        ...
        <div className="footer-cont">
          <div className="footer">
            ...
            <div className="social">
              ...
              <ul>
                <li>
                  <a href="https://www.instagram.com/mavyscrubs?igsh=dWpvMWM3NGl4cGps&utm_source=qr">
                    Instagram
                  </a>
                </li>
                <li>
                  <a href="https://www.facebook.com/profile.php?id=61566524166958&mibextid=wwXIfr&mibextid=wwXIfr">
                    Facebook
                  </a>
                </li>
